...
![[../../annex/Pasted image 20240109210222.png]]
默认的时候使用模式 6（x 方向从左到右，y 方向从上到下）
这 8 个方向的坐标，可以通过 0x36 命令来配置
![[../../annex/Pasted image 20240109210403.png]]
这 8 个方向对应图中这 3 个数据位的配置（MY、MX、MV）

![[../../annex/Pasted image 20240109210606.png]]
输入 0~7 选择方向模式，通过形参传入，左移 5 位作为 0x36 的命令的代码写进来（MX、MY、MV ）
或上0x08（0x08|）实际上就是配置数据位（BGR），出厂数据给我们的。我们只修改高 3 位（MX、MY、MV ）
![[../../annex/Pasted image 20240109211702.png]]

配置完扫描方向后，下面有一大段是用来配置液晶屏的开窗函数
![[../../annex/Pasted image 20240109211807.png]]
开窗的方向变了，根据实际上当前的分辨率修改开窗函数。

![[../../annex/Pasted image 20240109211957.png]]
根据不同的模式调整这两个全局变量
![[../../annex/Pasted image 20240109212055.png]]
...
![[../../annex/Pasted image 20240109230247.png]]
...
![[../../annex/Pasted image 20240109225012.png]]

![[../../annex/Pasted image 20240109225020.png]]
...
![[../../annex/Pasted image 20240109230754.png]]

![[../../annex/Pasted image 20240109230801.png]]
...
![[../../annex/Pasted image 20240109225129.png]]

###### 区位码
![[../../annex/Pasted image 20240109225151.png]]
...
![[../../annex/Pasted image 20240109225248.png]]
...
![[../../annex/Pasted image 20240109225329.png]]
