...
![[../../annex/Pasted image 20240127194229.png]]
...
![[../../annex/Pasted image 20240127195722.png]]

计数器计数一次的时间由分频因子 PSC 来决定，72 M÷（PSC+1）就是计数器的时钟，表示计数器的频率

![[../../annex/Pasted image 20240127195937.png]]
...
输出比较还要用到这个寄存器：
![[../../annex/Pasted image 20240127200115.png]]


![[../../annex/Pasted image 20240127200150.png]]
这个初始化结构体不需要配置

![[../../annex/Pasted image 20240127200219.png]]
刹车死区时间控制寄存器结构体
...
```
![[../../annex/Pasted image 20240127204258.png]]
ARR+1 是因为是从 0 开始计数的
...
![[../../annex/Pasted image 20240127205422.png]]
记得勾选 C99 标准、取消注释

![[../../annex/Pasted image 20240127211120.png]]
OC 代表正输出，OCN 代表互补输出
```
...
![[../../annex/Pasted image 20240127214400.png]]

RESET 状态（设置成低电平）
![[../../annex/Pasted image 20240127214511.png]]

指南者：
![[../../annex/Pasted image 20240127214557.png]]
...
![[../../annex/Pasted image 20240127213622.png]]

![[../../annex/Pasted image 20240127213629.png]]

![[../../annex/Pasted image 20240127213638.png]]
...
![[../../annex/Pasted image 20240127215521.png]]

需要在中断更新函数中，判断这个中断是什么中断
