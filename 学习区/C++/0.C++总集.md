...
3.深入分析
4.菱形继承
![[../../附件/0.C++总集_image_22.png]]

#### 重难点
1.语法
2.父子关系
![[../../附件/0.C++总集_image_23.png]]
...
##### 单继承
![[../../附件/0.C++总集_image_24.png]]

##### 多继承
继承的父类之间不需要有什么联系
继承个数不限
![[../../附件/0.C++总集_image_25.png]]
...
![[../../附件/0.C++总集_image_26.png]]

1.先分析类1 继承给类2 的权限
![[../../附件/0.C++总集_image_27.png]]

2.然后分析类 2继承给类3 的权限
![[../../附件/0.C++总集_image_28.png]]

3.再分析类 3 继承给类 4 的权限，得到最终的权限
![[../../附件/0.C++总集_image_29.png]]
...
![[../../附件/0.C++总集_image_30.png]]

![[../../附件/0.C++总集_image_31.png]]

👆验证 9 种情况中的第一列的情况👇
![[../../附件/五、继承与派生_image_12.png]]
...
![[../../附件/0.C++总集_image_33.png]]

![[../../附件/0.C++总集_image_34.png]]
...
![[../../附件/0.C++总集_image_43.png]]

直接这么写没问题
![[../../附件/0.C++总集_image_44.png]]

但是你要传参的话，就要这么写（在成员初始化列表中写上父类构造）
![[../../附件/0.C++总集_image_45.png]]

成员初始化列表语法是很灵活的，想怎么放就怎么放
![[../../附件/0.C++总集_image_46.png]]

同理
![[../../附件/五、继承与派生_image_27.png]]
...
![[../../附件/0.C++总集_image_47.png]]

类 A 派生出了类 A1, A2。
类 A1,类 A2 又共同派生出了新的类，类 AA。

![[../../附件/0.C++总集_image_48.png]]
...
![[../../附件/0.C++总集_image_49.png]]

类 AA 同时继承了两份类 A 的成员，浪费。

![[../../附件/0.C++总集_image_50.png]]

可以通过类名+成员名的形式，直接父类的类名就可以去得到它的这两个变量
类名 : : 成员名

![[../../附件/0.C++总集_image_51.png]]
...
* 纯虚函数
* final
![[../../附件/0.C++总集_image_57.png]]

##### 重点难点
* 多态
* 纯虚函数
![[../../附件/0.C++总集_image_58.png]]
...
![[../../附件/0.C++总集_image_59.png]]

![[../../附件/0.C++总集_image_60.png]]
结果：
![[../../附件/0.C++总集_image_61.png]]

不知为何，vscode 2022 会报错
![[../../附件/0.C++总集_image_62.png]]
...
![[../../附件/0.C++总集_image_70.png]]
👆（↑在析构函数前面加了 virtual 后↓）👇
![[../../附件/0.C++总集_image_71.png]]
...
![[../../附件/0.C++总集_image_72.png]]

然后在这个里面又继续调父类的析构。

![[../../附件/0.C++总集_image_73.png]]
...
![[../../附件/0.C++总集_image_70.png]] 👆（↑在析构函数前面加了 virtual 后↓）👇 ![[../../附件/0.C++总集_image_71.png]]
...
析构函数也可以写成纯虚函数
![[../../附件/0.C++总集_image_77.png]]

析构函数写成了纯虚函数，你还是要在类外去实现一下它
![[../../附件/0.C++总集_image_78.png]]
