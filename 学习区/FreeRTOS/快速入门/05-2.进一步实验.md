...
![[../../../annex/Pasted image 20240204212655.png]]
1、动态内存的使用
怎么表示任务？
- 可以使用面向对象的思想，任务控制块
- 可以动态分配
...
###### 优先级实验
![[../../../annex/Pasted image 20240204213021.png]]
...
![[../../../annex/Pasted image 20240204213711.png]]

在逻辑分析仪中右键点击 bit，然后全速运行。（使用鼠标的滚轮可以放大缩小）
![[../../../annex/Pasted image 20240204214157.png]]

![[../../../annex/Pasted image 20240204214009.png]]
3 个变量并不能同时为 1，基本上是交错开的，这证明了同优先级的任务是交叉执行的。

![[../../../annex/Pasted image 20240204214221.png]]
...
```
![[../../../annex/Pasted image 20240204220718.png]]
这是删除别人的任务。


想自删：
![[../../../annex/Pasted image 20240204220740.png]]
自删存入 NULL 即可
```
void Task2Function(void * param)
{
...
编译、调试、全速运行
![[../../../annex/Pasted image 20240204220859.png]]
...
![[../../../annex/Pasted image 20240204221247.png]]
所以说如果对于这个函数所创建的任务，想去删除它的话，必须记录它的返回值。


###### TaskGenericFunctoin 通用函数
![[../../../annex/Pasted image 20240204221623.png]]
这是一个通用的函数
```
...
```
调试、编译、全速运行
![[../../../annex/Pasted image 20240204225400.png]]
...
![[../../../annex/Pasted image 20240204231102.png]]
...
![[../../../annex/Pasted image 20240204232644.png]]
